...
public class AKTKiTestV2 {
    ...
    protected String getClassNameToTest() {
        return "week1.AKTKi";
    }

    private static final String DEFAULT_FILENAME = "test_program_for_junit.aktk";
    ...
    private void checkError(String program) throws IOException {
        ...
        try {
            ExecutionResult result = runJavaProgramViaClassReload(getClassNameToTest(), DEFAULT_FILENAME);
    ...
    private void check(String program, String expectedOutput, String filename) throws IOException {
        ...
        try {
            ExecutionResult result = runJavaProgramViaClassReload(getClassNameToTest(), filename);
    ...
    private static ExecutionResult runJavaProgramWithInput(String className, String input, String... args) throws IOException {
    ...
    public static class ExecutionResult {
        ExecutionResult(String out, String err) {
            this.out = out;
            this.err = err;
        }
        public String out;

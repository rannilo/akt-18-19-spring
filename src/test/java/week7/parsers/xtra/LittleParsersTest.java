...
public class LittleParsersTest {
    ...
    private TestParser<SAParser> saParser = new TestParser<>(SAParser.class);
    private TestParser<AcdcParser> acdcParser = new TestParser<>(AcdcParser.class);
    private TestParser<TypeParser> typeParser = new TestParser<>(TypeParser.class);

    @Test
    public void test01_SA1() throws Exception {
    ...
    @Test
    public void test02_SA2() throws Exception {
        saParser.accepts("aaaaacbbbbb");
        saParser.accepts("c");
        saParser.accepts("abbbbbbbdbbbbbbb");
        saParser.accepts("ad");
    ...
    @Test
    public void test03_SA3() throws Exception {
    ...
    @Test
    public void test06_acdc2() throws Exception {
        acdcParser.rejects("g", 0, "ac$", "/");
        acdcParser.rejects("ag", 1, "acd", "/");
    }

    @Test
    public void test07_acdc3() throws Exception {
    ...
    @Test
    public void test08_Type1() throws Exception {
    ...
    @Test
    public void test09_Type2() throws Exception {
        typeParser.accepts("int()");
        typeParser.accepts("int(*)");
        typeParser.rejects("(int)");
    ...
    @Test
    public void test10_Type3() throws Exception {
